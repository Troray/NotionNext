...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Roy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的互联网搬运工。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://#', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Roy-Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://yun.139.com/w/static/img/LOGO.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个互联网搬运工, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
